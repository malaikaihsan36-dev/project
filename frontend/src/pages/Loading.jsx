      ...
      <div className="flex h-screen w-full flex-col items-center justify-center gap-10 px-6">
        ...
        <div className="flex flex-col items-center gap-4">
          <div className="relative w-24 h-24 rounded-2xl bg-white/5 backdrop-blur-md border border-white/10 flex items-center justify-center shadow-2xl shadow-primary/20">
            <span className="material-symbols-outlined text-5xl text-white drop-shadow-[0_0_15px_rgba(200,19,236,0.6)]">
              palette
            </span>
        ...
        <div className="relative flex items-center justify-center w-24 h-24">
          ...
          <div className="absolute inset-2 rounded-full border-4 border-b-primary border-l-transparent border-t-transparent border-r-transparent animate-spin-slow" style={{ animationDirection: "reverse" }}></div>
        ...
        <div className="text-center">
          ...
          <p className="text-[#b49db9] text-sm mt-2">

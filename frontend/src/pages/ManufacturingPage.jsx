...
const ManufacturingPage = () => {
  ...
  const manufacturingJourney = [
    { num: "01", title: "Consultation", phase: "Phase 1: Pre-Press & Strategy", desc: "Initial technical audit, volume estimation, substrate consultation, and structural feasibility review with our senior sales engineers.", qc: "Requirements audit & MOQ verification", equipment: "Engineering Consultation & CAD Desk", image: "/images/about_plant_facility.svg" },
    { num: "02", title: "Design", phase: "Phase 1: Pre-Press & Strategy", desc: "CAD structural dieline engineering, graphic artwork layout, color separation, bleed verification, and 3D digital rendering.", qc: "Dieline accuracy & trap tolerance", equipment: "ArtiosCAD & Esko Pre-Press Workstation", image: "/images/machine_die_cutter.svg" },
    { num: "03", title: "Material Selection", phase: "Phase 1: Pre-Press & Strategy", desc: "Curating virgin Kraft, high-GSM duplex boards, rigid chipboards, velvet paperstocks, and eco-certified barrier substrates.", qc: "GSM density, burst test & grain direction", equipment: "Spectrophotometer & Caliper Testing", image: "/images/machine_folder_gluer.svg" },
    { num: "04", title: "Prototype", phase: "Phase 1: Pre-Press & Strategy", desc: "Physical 1:1 unprinted CAD sample creation for dimensional fit testing, structural load testing, and client approval.", qc: "Structural fit & crease folding audit", equipment: "Kongsberg Automated Sample Plotter", image: "/images/machine_color_qc.svg" },
    { num: "05", title: "Offset Printing", phase: "Phase 2: Production & Printing", desc: "High-volume commercial offset printing using multi-color Heidelberg & Komori presses with automated ink density control.", qc: "Pantone color matching (Delta E < 1.5)", equipment: "Heidelberg Speedmaster XL 6-Color Press", image: "/images/plant_press.png" },
    { num: "06", title: "Digital Printing", phase: "Phase 2: Production & Printing", desc: "High-resolution digital print runs for rapid variable data, custom short-run batches, and personalized packaging collateral.", qc: "Dot alignment & resolution verification", equipment: "HP Indigo Industrial Digital Press", image: "/images/labels_stickers.png" },
    { num: "07", title: "UV Printing", phase: "Phase 2: Production & Printing", desc: "Curing specialized UV varnishes for selective high-gloss spot UV accents, chemical resistance, and rich tactile depth.", qc: "Gloss level & UV cure adhesion test", equipment: "Automated Spot UV Varnish Machine", image: "/images/foil_emboss.png" },
    { num: "08", title: "Foiling", phase: "Phase 3: Finishing & Embellishment", desc: "Precision hot foil stamping in metallic gold, silver, bronze, holographic, and satin foil films.", qc: "Foil sharpness, flaking test & registration", equipment: "Bobst Automatic Hot Foil Stamper", image: "/images/ecommerce_packaging.png" },
    { num: "09", title: "Embossing", phase: "Phase 3: Finishing & Embellishment", desc: "Tactile multi-level 3D embossing & debossing for raised logos, micro-textures, and premium brand marks.", qc: "Emboss depth & substrate tear prevention", equipment: "Heavy Duty Hydraulic Embossing Press", image: "/images/foil_emboss.png" },
    { num: "10", title: "Die Cutting", phase: "Phase 3: Finishing & Embellishment", desc: "High-speed computerized heavy die-cutting, scoring, creasing, perforation, and exact contour trim.", qc: "Clean edge cut & fold line creasing integrity", equipment: "Bobst High-Speed Automatic Die-Cutter", image: "/images/plant_press.png" },
    { num: "11", title: "Quality Inspection", phase: "Phase 4: QA, Assembly & Logistics", desc: "100% manual and optical inspection of color registration, foil adhesion, glue strength, and structural integrity.", qc: "AQL 1.0 zero-defect sampling audit", equipment: "High-Speed Optical Defect Scanner", image: "/images/plant_press.png" },
    { num: "12", title: "Packaging", phase: "Phase 4: QA, Assembly & Logistics", desc: "Automated rigid box assembly, corner gluing, tissue wrapping, shrink wrapping, and protective export bundling.", qc: "Drop test & moisture-barrier sealing", equipment: "Automated Box Folder & Gluer Line", image: "/images/cad_dieline.png" },
    { num: "13", title: "Delivery", phase: "Phase 4: QA, Assembly & Logistics", desc: "Tracked nationwide logistics dispatch across Karachi, Lahore, Islamabad, and international export container shipping.", qc: "Transit protection & delivery confirmation", equipment: "Logistics Fleet & Freight Logistics", image: "/images/ecommerce_packaging.png" }
  ];

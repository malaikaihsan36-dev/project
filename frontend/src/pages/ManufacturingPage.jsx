...
const ManufacturingPage = () => {
  ...
  const manufacturingJourney = [
    { num: "01", title: "Consultation", phase: "Phase 1: Pre-Press & Strategy", desc: "Initial technical audit, volume estimation, substrate consultation, and structural feasibility review with our senior sales engineers.", qc: "Requirements audit & MOQ verification", equipment: "Engineering Consultation & CAD Desk", image: "/images/plant_press.png" },
    { num: "02", title: "Design", phase: "Phase 1: Pre-Press & Strategy", desc: "CAD structural dieline engineering, graphic artwork layout, color separation, bleed verification, and 3D digital rendering.", qc: "Dieline accuracy & trap tolerance", equipment: "ArtiosCAD & Esko Pre-Press Workstation", image: "/images/pharma_packaging.png" },
    { num: "03", title: "Material Selection", phase: "Phase 1: Pre-Press & Strategy", desc: "Curating virgin Kraft, high-GSM duplex boards, rigid chipboards, velvet paperstocks, and eco-certified barrier substrates.", qc: "GSM density, burst test & grain direction", equipment: "Spectrophotometer & Caliper Testing", image: "/images/rigid_manufacturing.png" },
    { num: "04", title: "Prototype", phase: "Phase 1: Pre-Press & Strategy", desc: "Physical 1:1 unprinted CAD sample creation for dimensional fit testing, structural load testing, and client approval.", qc: "Structural fit & crease folding audit", equipment: "Kongsberg Automated Sample Plotter", image: "/images/cad_dieline.png" },

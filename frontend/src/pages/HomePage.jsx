...
const HomePage = () => {
  ...
  const allCapabilitiesList = [
    { num: "01", title: "Offset Printing", category: "HEAVY PRINTING", desc: "Heidelberg & Komori multi-color commercial offset press runs with automated ink density calibration.", image: "https://images.unsplash.com/photo-1542744173-8e7e53415bb0?q=80&w=1200" },
    { num: "02", title: "Digital Printing", category: "HEAVY PRINTING", desc: "High-resolution digital print runs for rapid variable data, custom short-run batches, and instant proofs.", image: "/images/cad_dieline.png" },
    { num: "03", title: "UV Printing", category: "HEAVY PRINTING", desc: "Curing specialized UV inks and applying selective high-gloss spot UV varnish for rich visual depth.", image: "https://images.unsplash.com/photo-1581092160607-ee22621dd758?q=80&w=1200" },
    { num: "04", title: "DTF Printing", category: "HEAVY PRINTING", desc: "Direct-to-Film high-density apparel, canvas, and industrial fabric transfer printing.", image: "https://images.unsplash.com/photo-1581092335397-9583fe92d232?q=80&w=1200" },
    { num: "05", title: "Luxury Packaging", category: "PACKAGING & BOXES", desc: "Bespoke high-end retail packaging with magnetic closures, velvet inserts, and gold leaf accents.", image: "/images/plant_press.png" },
    { num: "06", title: "Food Packaging", category: "PACKAGING & BOXES", desc: "Food-grade barrier boards, greaseproof linings, and FDA-certified protective takeaway cartons.", image: "https://images.unsplash.com/photo-1563986768609-322da13575f3?q=80&w=1200" },
    { num: "07", title: "Rigid Boxes", category: "PACKAGING & BOXES", desc: "Heavy-chipboard setup boxes for luxury cosmetics, perfumes, electronics, and executive gifts.", image: "https://images.unsplash.com/photo-1507537297725-24a1c029d3ca?q=80&w=1200" },
    { num: "08", title: "Shopping Bags", category: "PACKAGING & BOXES", desc: "Custom paper shopping bags with reinforced handles, foil stamped logos, and heavy kraft stocks.", image: "/images/foil_emboss.png" },
    { num: "09", title: "Labels", category: "PACKAGING & BOXES", desc: "High-definition roll and sheet labels with waterproof, oil-resistant, and metallic foil finishes.", image: "https://images.unsplash.com/photo-1612817288484-6f916006741a?q=80&w=1200" },
    { num: "10", title: "Catalogues", category: "COMMERCIAL & BRANDING", desc: "Hardcover & softcover corporate product catalogues, saddle-stitched or perfect-bound.", image: "https://images.unsplash.com/photo-1616070829579-ec19d0772e2a?q=80&w=1200" },
    { num: "11", title: "Brochures", category: "COMMERCIAL & BRANDING", desc: "Tri-fold, z-fold, and gate-fold marketing collateral printed on premium silk cardstocks.", image: "https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?q=80&w=1200" },
    { num: "12", title: "Corporate Printing", category: "COMMERCIAL & BRANDING", desc: "Executive letterheads, embossed business cards, presentation folders, and corporate brand kits.", image: "/images/rigid_manufacturing.png" },

...
const HomePage = () => {
  ...
  const allCapabilitiesList = [
    ...
    { num: "03", title: "UV Printing", category: "HEAVY PRINTING", desc: "Curing specialized UV inks and applying selective high-gloss spot UV varnish for rich visual depth.", image: "/images/plant_press.png" },
    { num: "04", title: "DTF Printing", category: "HEAVY PRINTING", desc: "Direct-to-Film high-density apparel, canvas, and industrial fabric transfer printing.", image: "/images/plant_press.png" },
    ...
    { num: "06", title: "Food Packaging", category: "PACKAGING & BOXES", desc: "Food-grade barrier boards, greaseproof linings, and FDA-certified protective takeaway cartons.", image: "/images/plant_press.png" },
    { num: "07", title: "Rigid Boxes", category: "PACKAGING & BOXES", desc: "Heavy-chipboard setup boxes for luxury cosmetics, perfumes, electronics, and executive gifts.", image: "/images/corporate_packaging.png" },
    ...
    { num: "09", title: "Labels", category: "PACKAGING & BOXES", desc: "High-definition roll and sheet labels with waterproof, oil-resistant, and metallic foil finishes.", image: "/images/cosmetic_packaging.png" },
    { num: "10", title: "Catalogues", category: "COMMERCIAL & BRANDING", desc: "Hardcover & softcover corporate product catalogues, saddle-stitched or perfect-bound.", image: "/images/pharma_packaging.png" },
    { num: "11", title: "Brochures", category: "COMMERCIAL & BRANDING", desc: "Tri-fold, z-fold, and gate-fold marketing collateral printed on premium silk cardstocks.", image: "/images/plant_press.png" },
        ...
        <section id="about" className="py-28 relative border-b border-[#27272A]/50 bg-gradient-to-b from-[#09090B] via-[#0D0D0F] to-[#09090B]">
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="mt-20 pt-16 border-t border-[#27272A]/80">
              ...
              <ScrollReveal className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
                {[
                  {
                    year: "1991",

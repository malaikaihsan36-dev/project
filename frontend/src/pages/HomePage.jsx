...
const HomePage = () => {
  ...
  const allCapabilitiesList = [
    { num: "01", title: "Offset Printing", category: "HEAVY PRINTING", desc: "Heidelberg & Komori multi-color commercial offset press runs with automated ink density calibration.", image: "/images/step_01_consultation.svg" },
    { num: "02", title: "Digital Printing", category: "HEAVY PRINTING", desc: "High-resolution digital print runs for rapid variable data, custom short-run batches, and instant proofs.", image: "/images/step_02_design.svg" },
    { num: "03", title: "UV Printing", category: "HEAVY PRINTING", desc: "Curing specialized UV inks and applying selective high-gloss spot UV varnish for rich visual depth.", image: "/images/step_03_prototype.svg" },
    { num: "04", title: "DTF Printing", category: "HEAVY PRINTING", desc: "Direct-to-Film high-density apparel, canvas, and industrial fabric transfer printing.", image: "/images/step_04_sample.svg" },
    { num: "05", title: "Luxury Packaging", category: "PACKAGING & BOXES", desc: "Bespoke high-end retail packaging with magnetic closures, velvet inserts, and gold leaf accents.", image: "/images/step_05_offset.svg" },
    { num: "06", title: "Food Packaging", category: "PACKAGING & BOXES", desc: "Food-grade barrier boards, greaseproof linings, and FDA-certified protective takeaway cartons.", image: "/images/step_06_digital.svg" },
    { num: "07", title: "Rigid Boxes", category: "PACKAGING & BOXES", desc: "Heavy-chipboard setup boxes for luxury cosmetics, perfumes, electronics, and executive gifts.", image: "/images/step_07_uv.svg" },
    { num: "08", title: "Shopping Bags", category: "PACKAGING & BOXES", desc: "Custom paper shopping bags with reinforced handles, foil stamped logos, and heavy kraft stocks.", image: "/images/step_08_foiling.svg" },
    { num: "09", title: "Labels", category: "PACKAGING & BOXES", desc: "High-definition roll and sheet labels with waterproof, oil-resistant, and metallic foil finishes.", image: "/images/step_09_embossing.svg" },
    { num: "10", title: "Catalogues", category: "COMMERCIAL & BRANDING", desc: "Hardcover & softcover corporate product catalogues, saddle-stitched or perfect-bound.", image: "/images/step_10_diecutting.svg" },
    { num: "11", title: "Brochures", category: "COMMERCIAL & BRANDING", desc: "Tri-fold, z-fold, and gate-fold marketing collateral printed on premium silk cardstocks.", image: "/images/step_11_qa.svg" },
    { num: "12", title: "Corporate Printing", category: "COMMERCIAL & BRANDING", desc: "Executive letterheads, embossed business cards, presentation folders, and corporate brand kits.", image: "/images/step_12_assembly.svg" },
    { num: "13", title: "Retail Packaging", category: "PACKAGING & BOXES", desc: "Folding cartons, blister pack cards, product sleeves, and point-of-sale counter display boxes.", image: "/images/step_13_delivery.svg" },

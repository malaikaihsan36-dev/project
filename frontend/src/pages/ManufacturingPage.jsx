...
const ManufacturingPage = () => {
  ...
  const manufacturingJourney = [
    ...
    { num: "02", title: "Design", phase: "Phase 1: Pre-Press & Strategy", desc: "CAD structural dieline engineering, graphic artwork layout, color separation, bleed verification, and 3D digital rendering.", qc: "Dieline accuracy & trap tolerance", equipment: "ArtiosCAD & Esko Pre-Press Workstation", image: "/images/corporate_packaging.png" },
    { num: "03", title: "Material Selection", phase: "Phase 1: Pre-Press & Strategy", desc: "Curating virgin Kraft, high-GSM duplex boards, rigid chipboards, velvet paperstocks, and eco-certified barrier substrates.", qc: "GSM density, burst test & grain direction", equipment: "Spectrophotometer & Caliper Testing", image: "/images/ecommerce_packaging.png" },
